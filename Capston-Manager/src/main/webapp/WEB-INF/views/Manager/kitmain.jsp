...
<html dir="ltr" lang="en">
  ...
  <%@include file="../includes/ManagerHeader.jsp"%>
      ...
      <div class="page-wrapper">
          ...
          <!-- 상품 관리 -->
          <!-- ============================================================== -->
      	<form:form id="kitForm" name="kitForm" method="post">
					...
					<table class="goods_table">
						<thead>
							<tr>
								...
								<td class="th_column_3">판매가</td>
								<td class="th_column_3">재고</td>
								<td class="th_column_6">내용</td>
								<td class="th_column_4">등록일</td>
							</tr>
						</thead>
						<c:forEach var="kit" items="${kitList}" varStatus="status">
							<tr onclick="location.href='kitinfo?kno=${kit.kno}'" style="cursor:pointer">
								<td><c:out value="${status.index+1}"></c:out></td>
								<td><c:out
											value="${kit.kitname}"></c:out></td>
								<td><c:out value="${kit.stkitprice}"></c:out></td>
								<td><c:out value="${kit.kitstock}"></c:out></td>
								<td><c:out value="${kit.kitcontents}"></c:out></td>
								<td><c:out value="${kit.regdate}"></c:out></td>
							</tr>
						</c:forEach>
					</table>
			</div>
